      ...
      var i = /mobile/i.test(window.navigator.userAgent),
        a = {
          ...
          getElementViewTop: function (e, t) {
            for (
              var n, i = e.offsetTop, a = e.offsetParent;
              null !== a;
        ...
        return i(e, [{
          ...
          value: function () {
            ...
            this.player.template.list.addEventListener("click", function (t) {
              var n = void 0;
              n = "LI" === t.target.tagName.toUpperCase()
                ? t.target
                : t.target.parentElement;
              var i = parseInt(
                n.getElementsByClassName("aplayer-list-index")[0].innerHTML,
              ) - 1;
              i !== e.index
          ...
          value: function (e) {
            ...
            this.player.template.listOl.innerHTML += (0, a.default)({
              ...
              t && this.audios.length > 1 &&
              this.player.container.classList.add("aplayer-withlist"),
              this.player.randomOrder = r.default.randomOrder(
                this.audios.length,
              ),
              this.player.template.listCurs = this.player.container
                .querySelectorAll(".aplayer-list-cur"),
              this.player.template.listCurs[this.audios.length - 1].style
                .backgroundColor = e.theme || this.player.options.theme,
              n && ("random" === this.player.options.order
            ...
            if (
              ...
              if (this.audios.length > 1) {
                ...
                for (var n = e; n < t.length; n++) {
                  t[n].getElementsByClassName("aplayer-list-index")[0]
                    .textContent = n;
                }
      ...
      var s = function () {
        ...
        return i(e, [{
          ...
          value: function () {
            var e = this,
              t = function (t) {
                var n = ((t.clientX || t.changedTouches[0].clientX) -
                  a.default.getElementViewLeft(e.player.template.barWrap)) /
              ...
              n = function n(i) {
                ...
                var r = ((i.clientX || i.changedTouches[0].clientX) -
                  a.default.getElementViewLeft(e.player.template.barWrap)) /
                  e.player.template.barWrap.clientWidth;
                r = Math.max(r, 0),
                  r = Math.min(r, 1),
            ...
            this.player.template.order.addEventListener("click", function () {
              "list" === e.player.options.order
                ? (e.player.options.order = "random",
                  e.player.template.order.innerHTML = r.default.orderRandom)
        ...
        return a(e, [{
                ...
                e >= this.current[t][0] &&
                  ...
                  (this.index = t,
                    this.container.style.transform = "translateY(" +
                      16 * -this.index + "px)",
                    this.container.style.webkitTransform = "translateY(" +
                      16 * -this.index + "px)",
                    this.container.getElementsByClassName(
                      "aplayer-lrc-current",
                    )[0].classList.remove("aplayer-lrc-current"),
                    this.container.getElementsByTagName("p")[t].classList.add(
                      "aplayer-lrc-current",
                    ));
              }
            }
          ...
          value: function (e) {
            ...
            if (!this.parsed[e]) {
              ...
              } else {this.player.list.audios[e].lrc
      ...
      e.exports = function (e) {
        ...
        return a.fixed
          ? (t += '\n<div class="aplayer-list',
            ...
            r &&
            (t += "background-image: url(&quot;", t += o(r), t += "&quot;);"),
            t += "background-color: ",
            t += o(a.theme),
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        t.default = function (e) {
          var t = {
            container: e.element ||
              document.getElementsByClassName("aplayer")[0],
          ...
          return "[object Array]" !== Object.prototype.toString.call(e.audio) &&
            (e.audio = [e.audio]),
                ...
                : (o = "setImmediate$" + Math.random() + "$",
                  s = function (t) {
                    t.source === e && "string" == typeof t.data &&
                      0 === t.data.indexOf(o) && y(+t.data.slice(o.length));
                  },
                  e.addEventListener
          ...
          function e(t) {
            if (
              function (e, t) {
                ...
                this.options.lrcType && !this.options.fixed &&
          ...
          return i(e, [{
            ...
            value: function () {
              ...
              (!(arguments.length > 2 && void 0 !== arguments[2]) ||
                arguments[2]) &&
              this.list.audios[t] && (this.list.audios[t].theme = e),
